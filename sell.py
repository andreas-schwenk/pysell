...
# TODO: test python code with indents (e.g. a while loop)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("usage: python sell.py INPUT_PATH.txt")
        exit(-1)
